                                ...
                                <div className="card-content">
                                    <div className="media">
                                        <div className="media-content">
                                            <p className="title is-4">Caterers</p>
                                            <p className="subtitle is-6">Find the best chefs for your event.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="column">
                            <div className="card">
                                ...
                                <div className="card-content">
                                    <div className="media">
                                        <div className="media-content">
                                            <p className="title is-4">Musicians</p>
                                            <p className="subtitle is-6">Find musicians to play for your special day!</p>
                                        </div>
                                    </div>
                        ...
                        <div className="column">
                            <div className="card">
                                ...
                                <div className="card-content">
                                    <div className="media">
                                        <div className="media-content">
                                            <p className="title is-4">Planners</p>
                                            <p className="subtitle is-6">Find a planner to help plan your event.</p>
                                        </div>
                                    </div>
